...
namespace CVAT
{
    public partial class AuthClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_AuthCreateSocialLoginTokenSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_AuthCreateSocialLoginTokenSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_AuthCreateSocialLoginTokenSecurityRequirement0,
            };
        partial void PrepareAuthCreateSocialLoginTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? authParams,
            ref string id,
            ref string? process,
            ref string? scope,
            global::CVAT.SocialLoginSerializerExRequest request);
        partial void PrepareAuthCreateSocialLoginTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? scope,
            global::CVAT.SocialLoginSerializerExRequest request);
        partial void ProcessAuthCreateSocialLoginTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthCreateSocialLoginTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.Token> AuthCreateSocialLoginTokenAsync(
            string id,
        ...
        {
            var __response = await AuthCreateSocialLoginTokenAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.Token>> AuthCreateSocialLoginTokenAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAuthCreateSocialLoginTokenArguments(
                httpClient: HttpClient,
                authParams: ref authParams,
                id: ref id,
                process: ref process,
                scope: ref scope,
                request: request);
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthCreateSocialLoginTokenSecurityRequirements,
                operationName: "AuthCreateSocialLoginTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/auth/social/{id}/login/token/",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("auth_params", authParams)
                                .AddOptionalParameter("process", process)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthCreateSocialLoginTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthCreateSocialLoginToken",
                                methodName: "AuthCreateSocialLoginTokenAsync",
                                pathTemplate: "$\"/api/auth/social/{id}/login/token/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthCreateSocialLoginTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthCreateSocialLoginTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.Token.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.Token>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.Token.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.Token> AuthCreateSocialLoginTokenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.SocialLoginSerializerExRequest
            {
                AccessToken = accessToken,
                Code = code,
                IdToken = idToken,
                AuthParams = requestAuthParams,
                Process = requestProcess,
                Scope = requestScope,
            };

            return await AuthCreateSocialLoginTokenAsync(
                authParams: authParams,
                id: id,
                process: process,
                scope: scope,
