...
namespace CVAT
{
    public partial class TasksClient
    {
        ...
        {
            var __response = await TasksCreateBackupExportAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> TasksCreateBackupExportAsResponseAsync(
            int id,
            int? cloudStorageId = default,
            string? filename = default,
            bool? lightweight = default,
