...
namespace CVAT
{
    public partial class TasksClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_TasksRetrieveAnnotationsSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_TasksRetrieveAnnotationsSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_TasksRetrieveAnnotationsSecurityRequirement0,
            };
        partial void PrepareTasksRetrieveAnnotationsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id);
        partial void PrepareTasksRetrieveAnnotationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id);
        partial void ProcessTasksRetrieveAnnotationsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTasksRetrieveAnnotationsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.LabeledData> TasksRetrieveAnnotationsAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TasksRetrieveAnnotationsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.LabeledData>> TasksRetrieveAnnotationsAsResponseAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTasksRetrieveAnnotationsArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TasksRetrieveAnnotationsSecurityRequirements,
                operationName: "TasksRetrieveAnnotationsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTasksRetrieveAnnotationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TasksRetrieveAnnotations",
                                methodName: "TasksRetrieveAnnotationsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTasksRetrieveAnnotationsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTasksRetrieveAnnotationsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
