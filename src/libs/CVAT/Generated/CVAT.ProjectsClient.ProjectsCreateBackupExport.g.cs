...
namespace CVAT
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_ProjectsCreateBackupExportSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_ProjectsCreateBackupExportSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_ProjectsCreateBackupExportSecurityRequirement0,
            };
        partial void PrepareProjectsCreateBackupExportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? cloudStorageId,
            ref string? filename,
            ref int id,
            ref bool? lightweight,
            ref global::CVAT.ProjectsCreateBackupExportLocation? location);
        partial void PrepareProjectsCreateBackupExportRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int id,
            bool? lightweight,
            global::CVAT.ProjectsCreateBackupExportLocation? location);
        partial void ProcessProjectsCreateBackupExportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsCreateBackupExportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> ProjectsCreateBackupExportAsync(
            int id,
        ...
        {
            var __response = await ProjectsCreateBackupExportAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> ProjectsCreateBackupExportAsResponseAsync(
            int id,
            int? cloudStorageId = default,
            string? filename = default,
            bool? lightweight = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsCreateBackupExportArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectsCreateBackupExportSecurityRequirements,
                operationName: "ProjectsCreateBackupExportAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/projects/{id}/backup/export",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectsCreateBackupExportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsCreateBackupExport",
                                methodName: "ProjectsCreateBackupExportAsync",
                                pathTemplate: "$\"/api/projects/{id}/backup/export\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsCreateBackupExportResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsCreateBackupExportResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
