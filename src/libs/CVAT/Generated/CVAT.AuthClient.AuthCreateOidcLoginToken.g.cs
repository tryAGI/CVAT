...
namespace CVAT
{
    public partial class AuthClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_AuthCreateOidcLoginTokenSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_AuthCreateOidcLoginTokenSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_AuthCreateOidcLoginTokenSecurityRequirement0,
            };
        partial void PrepareAuthCreateOidcLoginTokenArguments(
        ...
        partial void PrepareAuthCreateOidcLoginTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? scope,
            global::CVAT.SocialLoginSerializerExRequest request);
        partial void ProcessAuthCreateOidcLoginTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthCreateOidcLoginTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.Token> AuthCreateOidcLoginTokenAsync(
            string id,
        ...
        {
            var __response = await AuthCreateOidcLoginTokenAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.Token>> AuthCreateOidcLoginTokenAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAuthCreateOidcLoginTokenArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthCreateOidcLoginTokenSecurityRequirements,
                operationName: "AuthCreateOidcLoginTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/auth/oidc/{id}/login/token/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthCreateOidcLoginTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthCreateOidcLoginToken",
                                methodName: "AuthCreateOidcLoginTokenAsync",
                                pathTemplate: "$\"/api/auth/oidc/{id}/login/token/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthCreateOidcLoginTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthCreateOidcLoginTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AuthCreateOidcLoginTokenAsync(
                authParams: authParams,
                id: id,
                process: process,
                scope: scope,
