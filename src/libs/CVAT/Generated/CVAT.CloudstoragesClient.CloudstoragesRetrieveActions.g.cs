...
namespace CVAT
{
    public partial class CloudstoragesClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_CloudstoragesRetrieveActionsSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_CloudstoragesRetrieveActionsSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_CloudstoragesRetrieveActionsSecurityRequirement0,
            };
        partial void PrepareCloudstoragesRetrieveActionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id);
        partial void PrepareCloudstoragesRetrieveActionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id);
        partial void ProcessCloudstoragesRetrieveActionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCloudstoragesRetrieveActionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CloudstoragesRetrieveActionsAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CloudstoragesRetrieveActionsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<string>> CloudstoragesRetrieveActionsAsResponseAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCloudstoragesRetrieveActionsArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CloudstoragesRetrieveActionsSecurityRequirements,
                operationName: "CloudstoragesRetrieveActionsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/cloudstorages/{id}/actions",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CloudstoragesRetrieveActions",
                                methodName: "CloudstoragesRetrieveActionsAsync",
                                pathTemplate: "$\"/api/cloudstorages/{id}/actions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCloudstoragesRetrieveActionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCloudstoragesRetrieveActionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::CVAT.AutoSDKHttpResponse<string>(
