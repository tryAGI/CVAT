...
namespace CVAT
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_OrganizationsDestroySecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_OrganizationsDestroySecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_OrganizationsDestroySecurityRequirement0,
            };
        partial void PrepareOrganizationsDestroyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id);
        partial void PrepareOrganizationsDestroyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id);
        partial void ProcessOrganizationsDestroyResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task OrganizationsDestroyAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await OrganizationsDestroyAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse> OrganizationsDestroyAsResponseAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOrganizationsDestroyArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OrganizationsDestroySecurityRequirements,
                operationName: "OrganizationsDestroyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOrganizationsDestroyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "OrganizationsDestroyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOrganizationsDestroyResponse(
                    httpClient: HttpClient,
