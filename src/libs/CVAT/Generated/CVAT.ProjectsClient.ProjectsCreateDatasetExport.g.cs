...
namespace CVAT
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_ProjectsCreateDatasetExportSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_ProjectsCreateDatasetExportSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_ProjectsCreateDatasetExportSecurityRequirement0,
            };
        partial void PrepareProjectsCreateDatasetExportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? cloudStorageId,
            ref string? filename,
            ref string format,
            ref int id,
            ref global::CVAT.ProjectsCreateDatasetExportLocation? location,
            ref bool? saveImages);
        partial void PrepareProjectsCreateDatasetExportRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string format,
            int id,
            global::CVAT.ProjectsCreateDatasetExportLocation? location,
            bool? saveImages);
        partial void ProcessProjectsCreateDatasetExportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsCreateDatasetExportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> ProjectsCreateDatasetExportAsync(
            string format,
            int id,
        ...
        {
            var __response = await ProjectsCreateDatasetExportAsResponseAsync(
                format: format,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> ProjectsCreateDatasetExportAsResponseAsync(
            string format,
            int id,
            int? cloudStorageId = default,
            string? filename = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsCreateDatasetExportArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectsCreateDatasetExportSecurityRequirements,
                operationName: "ProjectsCreateDatasetExportAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/projects/{id}/dataset/export",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectsCreateDatasetExportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsCreateDatasetExport",
                                methodName: "ProjectsCreateDatasetExportAsync",
                                pathTemplate: "$\"/api/projects/{id}/dataset/export\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsCreateDatasetExportResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                throw global::CVAT.ApiException<global::CVAT.RqId>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsCreateDatasetExportResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
