...
namespace CVAT
{
    public partial class TasksClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_TasksCreateDatasetExportSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_TasksCreateDatasetExportSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_TasksCreateDatasetExportSecurityRequirement0,
            };
        partial void PrepareTasksCreateDatasetExportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? cloudStorageId,
            ref string? filename,
            ref string format,
            ref int id,
            ref global::CVAT.TasksCreateDatasetExportLocation? location,
            ref bool? saveImages);
        partial void PrepareTasksCreateDatasetExportRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string format,
            int id,
            global::CVAT.TasksCreateDatasetExportLocation? location,
            bool? saveImages);
        partial void ProcessTasksCreateDatasetExportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTasksCreateDatasetExportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> TasksCreateDatasetExportAsync(
            string format,
            int id,
        ...
        {
            var __response = await TasksCreateDatasetExportAsResponseAsync(
                format: format,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> TasksCreateDatasetExportAsResponseAsync(
            string format,
            int id,
            int? cloudStorageId = default,
            string? filename = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTasksCreateDatasetExportArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TasksCreateDatasetExportSecurityRequirements,
                operationName: "TasksCreateDatasetExportAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/tasks/{id}/dataset/export",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTasksCreateDatasetExportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TasksCreateDatasetExport",
                                methodName: "TasksCreateDatasetExportAsync",
                                pathTemplate: "$\"/api/tasks/{id}/dataset/export\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTasksCreateDatasetExportResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTasksCreateDatasetExportResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
