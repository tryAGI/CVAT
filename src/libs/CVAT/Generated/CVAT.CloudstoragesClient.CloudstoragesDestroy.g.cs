...
namespace CVAT
{
    public partial class CloudstoragesClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_CloudstoragesDestroySecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_CloudstoragesDestroySecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_CloudstoragesDestroySecurityRequirement0,
            };
        partial void PrepareCloudstoragesDestroyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id);
        partial void PrepareCloudstoragesDestroyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id);
        partial void ProcessCloudstoragesDestroyResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CloudstoragesDestroyAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await CloudstoragesDestroyAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse> CloudstoragesDestroyAsResponseAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCloudstoragesDestroyArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CloudstoragesDestroySecurityRequirements,
                operationName: "CloudstoragesDestroyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCloudstoragesDestroyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CloudstoragesDestroy",
                                methodName: "CloudstoragesDestroyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCloudstoragesDestroyResponse(
                    httpClient: HttpClient,
