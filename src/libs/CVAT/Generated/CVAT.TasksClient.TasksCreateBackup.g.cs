...
namespace CVAT
{
    public partial class TasksClient
    {
        ...
        {
            var __response = await TasksCreateBackupAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> TasksCreateBackupAsResponseAsync(
                ...
                __httpRequest.Headers.TryAddWithoutValidation("X-Organization", xOrganization.ToString());
                            ...
                            __contentTaskFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.TaskFilename is null
                                    ...
                                    : (global::System.IO.Path.GetExtension(request.TaskFilename) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            __httpRequestContent.Add(
                                content: __contentTaskFile,
                                name: "\"task_file\"",
                                fileName: request.TaskFilename != null ? $"\"{request.TaskFilename}\"" : string.Empty);
                            if (__contentTaskFile.Headers.ContentDisposition != null)
                            {
                                __contentTaskFile.Headers.ContentDisposition.FileNameStar = null;
                            }
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TasksCreateBackup",
                                methodName: "TasksCreateBackupAsync",
                                pathTemplate: "\"/api/tasks/backup/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
        ...
        /// <param name="orgId"></param>
        /// <param name="taskFile">
        /// The stream to send as the multipart 'task_file' file part.
        /// </param>
        /// <param name="taskFilename"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> TasksCreateBackupAsync(
            global::System.IO.Stream taskFile,
            string taskFilename,
            string? xOrganization = default,
            int? cloudStorageId = default,
            string? filename = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            taskFile = taskFile ?? throw new global::System.ArgumentNullException(nameof(taskFile));
            var request = new global::CVAT.TaskFileRequest
            {
                TaskFile = global::System.Array.Empty<byte>(),
                TaskFilename = taskFilename,
            };
            PrepareArguments(
                client: HttpClient);
