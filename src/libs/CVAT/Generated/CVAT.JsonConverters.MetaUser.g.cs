...
{
    /// <inheritdoc />
    public class MetaUserJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::CVAT.MetaUser>
    {
        /// <inheritdoc />
        public override global::CVAT.MetaUser Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("is_active")) __score0++;
            if (__jsonProps.Contains("is_staff")) __score0++;
            if (__jsonProps.Contains("is_superuser")) __score0++;
            if (__jsonProps.Contains("last_login")) __score0++;
            if (__jsonProps.Contains("last_name")) __score0++;
            if (__jsonProps.Contains("url")) __score0++;
            if (__jsonProps.Contains("username")) __score0++;
            var __score1 = 0;
            if (__jsonProps.Contains("first_name")) __score1++;
            if (__jsonProps.Contains("id")) __score1++;
            if (__jsonProps.Contains("last_name")) __score1++;
            if (__jsonProps.Contains("url")) __score1++;
            if (__jsonProps.Contains("username")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::CVAT.User? value1 = default;
            global::CVAT.BasicUser? value2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::CVAT.MetaUser(
                value1,
