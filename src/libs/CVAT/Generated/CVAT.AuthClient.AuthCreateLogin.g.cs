...
namespace CVAT
{
    public partial class AuthClient
    {
        ...
        partial void PrepareAuthCreateLoginRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::CVAT.LoginSerializerExRequest request);
        partial void ProcessAuthCreateLoginResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthCreateLoginResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.Token> AuthCreateLoginAsync(

            global::CVAT.LoginSerializerExRequest request,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AuthCreateLoginAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.Token>> AuthCreateLoginAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAuthCreateLoginArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthCreateLogin",
                                methodName: "AuthCreateLoginAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthCreateLoginResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthCreateLoginResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.Token> AuthCreateLoginAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.LoginSerializerExRequest
            {
                Username = username,
                Email = email,
                Password = password,
            ...
            return await AuthCreateLoginAsync(
                request: __request,
                requestOptions: requestOptions,
