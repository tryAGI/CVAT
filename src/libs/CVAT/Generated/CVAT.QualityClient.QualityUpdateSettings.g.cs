...
namespace CVAT
{
    public partial class QualityClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_QualityUpdateSettingsSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_QualityUpdateSettingsSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_QualityUpdateSettingsSecurityRequirement0,
            };
        partial void PrepareQualityUpdateSettingsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::CVAT.QualitySettingsRequest request);
        partial void PrepareQualityUpdateSettingsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::CVAT.QualitySettingsRequest request);
        partial void ProcessQualityUpdateSettingsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQualityUpdateSettingsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.QualitySettings> QualityUpdateSettingsAsync(
            int id,
        ...
        {
            var __response = await QualityUpdateSettingsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.QualitySettings>> QualityUpdateSettingsAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQualityUpdateSettingsArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QualityUpdateSettingsSecurityRequirements,
                operationName: "QualityUpdateSettingsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQualityUpdateSettingsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QualityUpdateSettings",
                                methodName: "QualityUpdateSettingsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQualityUpdateSettingsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQualityUpdateSettingsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.QualitySettings.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.QualitySettings>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.QualitySettings.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.QualitySettings> QualityUpdateSettingsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.QualitySettingsRequest
            {
                JobFilter = jobFilter,
                Inherit = inherit,
            ...
            return await QualityUpdateSettingsAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
