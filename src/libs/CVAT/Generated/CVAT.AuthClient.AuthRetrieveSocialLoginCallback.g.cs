...
namespace CVAT
{
    public partial class AuthClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_AuthRetrieveSocialLoginCallbackSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_AuthRetrieveSocialLoginCallbackSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_AuthRetrieveSocialLoginCallbackSecurityRequirement0,
            };
        partial void PrepareAuthRetrieveSocialLoginCallbackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? code,
            ref string id,
            ref string? state);
        partial void PrepareAuthRetrieveSocialLoginCallbackRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? code,
            string id,
            string? state);
        partial void ProcessAuthRetrieveSocialLoginCallbackResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AuthRetrieveSocialLoginCallbackAsync(
            string id,
            string? code = default,
        ...
        {
            await AuthRetrieveSocialLoginCallbackAsResponseAsync(
                id: id,
                code: code,
                state: state,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse> AuthRetrieveSocialLoginCallbackAsResponseAsync(
            string id,
            string? code = default,
            string? state = default,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAuthRetrieveSocialLoginCallbackArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthRetrieveSocialLoginCallbackSecurityRequirements,
                operationName: "AuthRetrieveSocialLoginCallbackAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/auth/social/{id}/login/callback/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthRetrieveSocialLoginCallbackRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthRetrieveSocialLoginCallback",
                                methodName: "AuthRetrieveSocialLoginCallbackAsync",
                                pathTemplate: "$\"/api/auth/social/{id}/login/callback/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthRetrieveSocialLoginCallbackResponse(
                    httpClient: HttpClient,
