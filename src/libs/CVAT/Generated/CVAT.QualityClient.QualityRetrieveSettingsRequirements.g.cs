...
namespace CVAT
{
    public partial class QualityClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_QualityRetrieveSettingsRequirementsSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_QualityRetrieveSettingsRequirementsSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_QualityRetrieveSettingsRequirementsSecurityRequirement0,
            };
        partial void PrepareQualityRetrieveSettingsRequirementsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id);
        partial void PrepareQualityRetrieveSettingsRequirementsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id);
        partial void ProcessQualityRetrieveSettingsRequirementsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQualityRetrieveSettingsRequirementsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.QualityRequirement> QualityRetrieveSettingsRequirementsAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await QualityRetrieveSettingsRequirementsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.QualityRequirement>> QualityRetrieveSettingsRequirementsAsResponseAsync(
            int id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareQualityRetrieveSettingsRequirementsArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QualityRetrieveSettingsRequirementsSecurityRequirements,
                operationName: "QualityRetrieveSettingsRequirementsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQualityRetrieveSettingsRequirementsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QualityRetrieveSettingsRequirements",
                                methodName: "QualityRetrieveSettingsRequirementsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQualityRetrieveSettingsRequirementsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQualityRetrieveSettingsRequirementsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
