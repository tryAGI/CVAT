...
namespace CVAT
{
    public partial class QualityClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_QualityListConflictsSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_QualityListConflictsSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_QualityListConflictsSecurityRequirement0,
            };
        partial void PrepareQualityListConflictsArguments(
            ...
            ref int? projectId,
            ref int? reportId,
            ref global::CVAT.QualityListConflictsSeverity? severity,
            ref string? sort,
            ref int? taskId,
            ref global::CVAT.QualityListConflictsType? type);
        partial void PrepareQualityListConflictsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? projectId,
            int? reportId,
            global::CVAT.QualityListConflictsSeverity? severity,
            string? sort,
            int? taskId,
            global::CVAT.QualityListConflictsType? type);
        partial void ProcessQualityListConflictsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQualityListConflictsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.PaginatedAnnotationConflictList> QualityListConflictsAsync(
        ...
        {
            var __response = await QualityListConflictsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedAnnotationConflictList>> QualityListConflictsAsResponseAsync(
            string? xOrganization = default,
            string? filter = default,
            int? frame = default,
            int? jobId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareQualityListConflictsArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QualityListConflictsSecurityRequirements,
                operationName: "QualityListConflictsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: "/api/quality/conflicts",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("filter", filter)
                                .AddOptionalParameter("frame", frame?.ToString())
            ...
            if (xOrganization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQualityListConflictsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QualityListConflicts",
                                methodName: "QualityListConflictsAsync",
                                pathTemplate: "\"/api/quality/conflicts\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQualityListConflictsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQualityListConflictsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.PaginatedAnnotationConflictList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedAnnotationConflictList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.PaginatedAnnotationConflictList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
