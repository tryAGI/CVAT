...
namespace CVAT
{
    public partial class ConsensusClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_ConsensusCreateMergeSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_ConsensusCreateMergeSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_ConsensusCreateMergeSecurityRequirement0,
            };
        partial void PrepareConsensusCreateMergeArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::CVAT.ConsensusMergeCreateRequest request);
        partial void PrepareConsensusCreateMergeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::CVAT.ConsensusMergeCreateRequest request);
        partial void ProcessConsensusCreateMergeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessConsensusCreateMergeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> ConsensusCreateMergeAsync(

            global::CVAT.ConsensusMergeCreateRequest request,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ConsensusCreateMergeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> ConsensusCreateMergeAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareConsensusCreateMergeArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ConsensusCreateMergeSecurityRequirements,
                operationName: "ConsensusCreateMergeAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareConsensusCreateMergeRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ConsensusCreateMerge",
                                methodName: "ConsensusCreateMergeAsync",
                                pathTemplate: "\"/api/consensus/merges\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessConsensusCreateMergeResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessConsensusCreateMergeResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> ConsensusCreateMergeAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.ConsensusMergeCreateRequest
            {
                TaskId = taskId,
                JobId = jobId,
            };

            return await ConsensusCreateMergeAsync(
                request: __request,
                requestOptions: requestOptions,
