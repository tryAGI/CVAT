...
namespace CVAT
{
    public partial class JobsClient
    {
        ...
        partial void PrepareJobsCreateAnnotationsArguments(
            ...
            ref string? format,
            ref int id,
            ref global::CVAT.JobsCreateAnnotationsImportMode? importMode,
            ref global::CVAT.JobsCreateAnnotationsLocation? location,
            ref bool? useDefaultLocation,
            global::CVAT.AnnotationFileRequest request);
        partial void PrepareJobsCreateAnnotationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? format,
            int id,
            global::CVAT.JobsCreateAnnotationsImportMode? importMode,
            global::CVAT.JobsCreateAnnotationsLocation? location,
            bool? useDefaultLocation,
            global::CVAT.AnnotationFileRequest request);
        partial void ProcessJobsCreateAnnotationsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessJobsCreateAnnotationsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> JobsCreateAnnotationsAsync(
            int id,
        ...
        {
            var __response = await JobsCreateAnnotationsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> JobsCreateAnnotationsAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareJobsCreateAnnotationsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __contentAnnotationFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.AnnotationFilename is null
                                    ...
                                    : (global::System.IO.Path.GetExtension(request.AnnotationFilename) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            __httpRequestContent.Add(
                                content: __contentAnnotationFile,
                                name: "\"annotation_file\"",
                                fileName: request.AnnotationFilename != null ? $"\"{request.AnnotationFilename}\"" : string.Empty);
                            if (__contentAnnotationFile.Headers.ContentDisposition != null)
                            {
                                __contentAnnotationFile.Headers.ContentDisposition.FileNameStar = null;
                            }
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareJobsCreateAnnotationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "JobsCreateAnnotations",
                                methodName: "JobsCreateAnnotationsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessJobsCreateAnnotationsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessJobsCreateAnnotationsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await JobsCreateAnnotationsAsync(
                cloudStorageId: cloudStorageId,
                filename: filename,
                format: format,
                id: id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            annotationFile = annotationFile ?? throw new global::System.ArgumentNullException(nameof(annotationFile));
            var request = new global::CVAT.AnnotationFileRequest
            {
                AnnotationFile = global::System.Array.Empty<byte>(),
                AnnotationFilename = annotationFilename,
            };
            PrepareArguments(
                client: HttpClient);
