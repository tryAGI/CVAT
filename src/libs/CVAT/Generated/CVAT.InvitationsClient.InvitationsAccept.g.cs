                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::CVAT.AcceptInvitationRead.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::CVAT.AcceptInvitationRead.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
