...
namespace CVAT
{
    public partial class AuthClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_AuthCreateSamlLoginTokenSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_AuthCreateSamlLoginTokenSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_AuthCreateSamlLoginTokenSecurityRequirement0,
            };
        partial void PrepareAuthCreateSamlLoginTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareAuthCreateSamlLoginTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessAuthCreateSamlLoginTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAuthCreateSamlLoginTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.Token> AuthCreateSamlLoginTokenAsync(
            string id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AuthCreateSamlLoginTokenAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.Token>> AuthCreateSamlLoginTokenAsResponseAsync(
            string id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAuthCreateSamlLoginTokenArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthCreateSamlLoginTokenSecurityRequirements,
                operationName: "AuthCreateSamlLoginTokenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/auth/saml/{id}/login/token/",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthCreateSamlLoginTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthCreateSamlLoginToken",
                                methodName: "AuthCreateSamlLoginTokenAsync",
                                pathTemplate: "$\"/api/auth/saml/{id}/login/token/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthCreateSamlLoginTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAuthCreateSamlLoginTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
