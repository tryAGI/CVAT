...
namespace CVAT
{
    public partial class QualityClient
    {
        ...
        {
            var __response = await QualityListJobValidationsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedJobValidationList>> QualityListJobValidationsAsResponseAsync(
            string? xOrganization = default,
            int? assignee = default,
            string? filter = default,
            int? jobId = default,
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.PaginatedJobValidationList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedJobValidationList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.PaginatedJobValidationList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
