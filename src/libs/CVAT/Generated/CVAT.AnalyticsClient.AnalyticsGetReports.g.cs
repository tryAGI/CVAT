...
namespace CVAT
{
    public partial class AnalyticsClient
    {
        ...
        {
            var __response = await AnalyticsGetReportsAsResponseAsync(
                endDate: endDate,
                jobId: jobId,
                projectId: projectId,
                startDate: startDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.AnalyticsReport>> AnalyticsGetReportsAsResponseAsync(
            global::System.DateTime? endDate = default,
            int? jobId = default,
            int? projectId = default,
            global::System.DateTime? startDate = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AnalyticsGetReportsAsync",
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.AnalyticsReport.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.AnalyticsReport>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.AnalyticsReport.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
