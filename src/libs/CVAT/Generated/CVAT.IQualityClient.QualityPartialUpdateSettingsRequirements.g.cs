...
namespace CVAT
{
    public partial interface IQualityClient
    {
        ...
        global::System.Threading.Tasks.Task<global::CVAT.QualityRequirement> QualityPartialUpdateSettingsRequirementsAsync(
            int id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.QualityRequirement>> QualityPartialUpdateSettingsRequirementsAsResponseAsync(
            int id,
