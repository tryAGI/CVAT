...
namespace CVAT
{
    public partial class CloudstoragesClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_CloudstoragesPartialUpdateSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_CloudstoragesPartialUpdateSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_CloudstoragesPartialUpdateSecurityRequirement0,
            };
        ...
        {
            var __response = await CloudstoragesPartialUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.CloudStorageRead>> CloudstoragesPartialUpdateAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CloudstoragesPartialUpdateSecurityRequirements,
                operationName: "CloudstoragesPartialUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.ProviderType != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.ProviderType).HasValue ? (request.ProviderType).GetValueOrDefault().ToValueString() : string.Empty),
                                    name: "\"provider_type\"");
                            ...
                            if (request.CredentialsType != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.CredentialsType).HasValue ? (request.CredentialsType).GetValueOrDefault().ToValueString() : string.Empty),
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CloudstoragesPartialUpdate",
                                methodName: "CloudstoragesPartialUpdateAsync",
