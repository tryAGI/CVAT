...
namespace CVAT
{
    public partial class QualityClient
    {
        ...
        {
            var __response = await QualityPartialUpdateSettingsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.QualitySettings>> QualityPartialUpdateSettingsAsResponseAsync(
            int id,
