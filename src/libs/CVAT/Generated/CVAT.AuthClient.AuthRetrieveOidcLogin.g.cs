...
namespace CVAT
{
    public partial class AuthClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_AuthRetrieveOidcLoginSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_AuthRetrieveOidcLoginSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_AuthRetrieveOidcLoginSecurityRequirement0,
            };
        partial void PrepareAuthRetrieveOidcLoginArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareAuthRetrieveOidcLoginRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessAuthRetrieveOidcLoginResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AuthRetrieveOidcLoginAsync(
            string id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await AuthRetrieveOidcLoginAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse> AuthRetrieveOidcLoginAsResponseAsync(
            string id,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAuthRetrieveOidcLoginArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AuthRetrieveOidcLoginSecurityRequirements,
                operationName: "AuthRetrieveOidcLoginAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAuthRetrieveOidcLoginRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AuthRetrieveOidcLogin",
                                methodName: "AuthRetrieveOidcLoginAsync",
                                pathTemplate: "$\"/api/auth/oidc/{id}/login/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAuthRetrieveOidcLoginResponse(
                    httpClient: HttpClient,
