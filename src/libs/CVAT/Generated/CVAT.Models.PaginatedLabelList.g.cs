...
namespace CVAT
{
    ...
    public sealed partial class PaginatedLabelList
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::CVAT.Label> Results { get; set; }
        ...
        public PaginatedLabelList(
            int count,
            global::System.Collections.Generic.IList<global::CVAT.Label> results,
            string? next,
            string? previous)
        {
            this.Count = count;
