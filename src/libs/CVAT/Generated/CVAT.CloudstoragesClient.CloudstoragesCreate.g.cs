...
namespace CVAT
{
    public partial class CloudstoragesClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_CloudstoragesCreateSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_CloudstoragesCreateSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_CloudstoragesCreateSecurityRequirement0,
            };
        ...
        {
            var __response = await CloudstoragesCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.CloudStorageRead>> CloudstoragesCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CloudstoragesCreateSecurityRequirements,
                operationName: "CloudstoragesCreateAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CloudstoragesCreate",
                                methodName: "CloudstoragesCreateAsync",
                                pathTemplate: "\"/api/cloudstorages\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
