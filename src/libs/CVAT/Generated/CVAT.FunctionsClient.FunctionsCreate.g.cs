...
namespace CVAT
{
    public partial class FunctionsClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_FunctionsCreateSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_FunctionsCreateSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_FunctionsCreateSecurityRequirement0,
            };
        partial void PrepareFunctionsCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::CVAT.FunctionRequest request);
        partial void PrepareFunctionsCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::CVAT.FunctionRequest request);
        partial void ProcessFunctionsCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFunctionsCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await FunctionsCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.Function>> FunctionsCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareFunctionsCreateArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FunctionsCreateSecurityRequirements,
                operationName: "FunctionsCreateAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "FunctionsCreateAsync",
                                pathTemplate: "\"/api/functions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFunctionsCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFunctionsCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.Function> FunctionsCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.FunctionRequest
            {
                Provider = provider,
                Url = url,
                ApiKey = apiKey,
            ...
            return await FunctionsCreateAsync(
                request: __request,
                requestOptions: requestOptions,
