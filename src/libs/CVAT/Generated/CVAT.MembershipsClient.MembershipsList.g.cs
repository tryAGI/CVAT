...
namespace CVAT
{
    public partial class MembershipsClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_MembershipsListSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_MembershipsListSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_MembershipsListSecurityRequirement0,
            };
        partial void PrepareMembershipsListArguments(
            ...
            ref int? page,
            ref int? pageSize,
            ref global::CVAT.MembershipsListRole? role,
            ref string? search,
            ref string? sort,
            ref string? user);
        partial void PrepareMembershipsListRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? page,
            int? pageSize,
            global::CVAT.MembershipsListRole? role,
            string? search,
            string? sort,
            string? user);
        partial void ProcessMembershipsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMembershipsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.PaginatedMembershipReadList> MembershipsListAsync(
        ...
        {
            var __response = await MembershipsListAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedMembershipReadList>> MembershipsListAsResponseAsync(
            string? xOrganization = default,
            string? filter = default,
            string? org = default,
            int? orgId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMembershipsListArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MembershipsListSecurityRequirements,
                operationName: "MembershipsListAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "MembershipsListAsync",
                                pathTemplate: "\"/api/memberships\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMembershipsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMembershipsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.PaginatedMembershipReadList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedMembershipReadList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.PaginatedMembershipReadList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
