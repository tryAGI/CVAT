...
namespace CVAT
{
    public partial class TasksClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_TasksPartialUpdateValidationLayoutSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_TasksPartialUpdateValidationLayoutSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_TasksPartialUpdateValidationLayoutSecurityRequirement0,
            };
        partial void PrepareTasksPartialUpdateValidationLayoutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::CVAT.PatchedTaskValidationLayoutWriteRequest request);
        partial void PrepareTasksPartialUpdateValidationLayoutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::CVAT.PatchedTaskValidationLayoutWriteRequest request);
        partial void ProcessTasksPartialUpdateValidationLayoutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTasksPartialUpdateValidationLayoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.TaskValidationLayoutRead> TasksPartialUpdateValidationLayoutAsync(
            int id,
        ...
        {
            var __response = await TasksPartialUpdateValidationLayoutAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.TaskValidationLayoutRead>> TasksPartialUpdateValidationLayoutAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTasksPartialUpdateValidationLayoutArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TasksPartialUpdateValidationLayoutSecurityRequirements,
                operationName: "TasksPartialUpdateValidationLayoutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/tasks/{id}/validation_layout",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTasksPartialUpdateValidationLayoutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TasksPartialUpdateValidationLayout",
                                methodName: "TasksPartialUpdateValidationLayoutAsync",
                                pathTemplate: "$\"/api/tasks/{id}/validation_layout\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTasksPartialUpdateValidationLayoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTasksPartialUpdateValidationLayoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.TaskValidationLayoutRead.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.TaskValidationLayoutRead>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.TaskValidationLayoutRead.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.TaskValidationLayoutRead> TasksPartialUpdateValidationLayoutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.PatchedTaskValidationLayoutWriteRequest
            {
                DisabledFrames = disabledFrames,
                FrameSelectionMethod = frameSelectionMethod,
                HoneypotRealFrames = honeypotRealFrames,
            };

            return await TasksPartialUpdateValidationLayoutAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
