...
namespace CVAT
{
    public partial class TasksClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_TasksCreateSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_TasksCreateSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_TasksCreateSecurityRequirement0,
            };
        partial void PrepareTasksCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xOrganization,
            ref string? org,
            ref int? orgId,
            global::CVAT.TaskWriteRequest request);
        partial void PrepareTasksCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? orgId,
            global::CVAT.TaskWriteRequest request);
        partial void ProcessTasksCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTasksCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await TasksCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.TaskRead>> TasksCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TasksCreateSecurityRequirements,
                operationName: "TasksCreateAsync");
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTasksCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.TaskRead> TasksCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.TaskWriteRequest
            {
                Name = name,
                ProjectId = projectId,
                OwnerId = ownerId,
                ...
                ConsensusReplicas = consensusReplicas,
            };

            return await TasksCreateAsync(
                xOrganization: xOrganization,
                org: org,
                orgId: orgId,
                request: __request,
