...
namespace CVAT
{
    public partial class QualityClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_QualityListSettingsSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_QualityListSettingsSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_QualityListSettingsSecurityRequirement0,
            };
        ...
        {
            var __response = await QualityListSettingsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedQualitySettingsList>> QualityListSettingsAsResponseAsync(
            string? xOrganization = default,
            string? filter = default,
            bool? inherit = default,
            string? org = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QualityListSettingsSecurityRequirements,
                operationName: "QualityListSettingsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QualityListSettings",
                                methodName: "QualityListSettingsAsync",
                                pathTemplate: "\"/api/quality/settings\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.PaginatedQualitySettingsList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedQualitySettingsList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.PaginatedQualitySettingsList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
