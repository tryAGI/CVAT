...
namespace CVAT
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::CVAT.AutoSDKRetryOptions Retry { get; set; } = new global::CVAT.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::CVAT.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::CVAT.IAutoSDKHook>();
        ...
        public global::CVAT.AutoSDKClientOptions AddHook(
            global::CVAT.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::CVAT.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::CVAT.AutoSDKClientOptions UseAuthorizationProvider(
            global::CVAT.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::CVAT.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::CVAT.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::CVAT.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::CVAT.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::CVAT.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::CVAT.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::CVAT.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::CVAT.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::CVAT.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::CVAT.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::CVAT.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::CVAT.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::CVAT.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::CVAT.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::CVAT.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::CVAT.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::CVAT.AutoSDKClientOptions clientOptions,
            global::CVAT.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::CVAT.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::CVAT.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::CVAT.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::CVAT.AutoSDKClientOptions clientOptions,
            global::System.Func<global::CVAT.IAutoSDKHook, global::CVAT.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::CVAT.AutoSDKHookContext context)
        {
