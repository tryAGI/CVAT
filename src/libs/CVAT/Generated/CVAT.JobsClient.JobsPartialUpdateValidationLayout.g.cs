...
namespace CVAT
{
    public partial class JobsClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_JobsPartialUpdateValidationLayoutSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_JobsPartialUpdateValidationLayoutSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_JobsPartialUpdateValidationLayoutSecurityRequirement0,
            };
        partial void PrepareJobsPartialUpdateValidationLayoutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::CVAT.PatchedJobValidationLayoutWriteRequest request);
        partial void PrepareJobsPartialUpdateValidationLayoutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::CVAT.PatchedJobValidationLayoutWriteRequest request);
        partial void ProcessJobsPartialUpdateValidationLayoutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessJobsPartialUpdateValidationLayoutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.JobValidationLayoutRead> JobsPartialUpdateValidationLayoutAsync(
            int id,
        ...
        {
            var __response = await JobsPartialUpdateValidationLayoutAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.JobValidationLayoutRead>> JobsPartialUpdateValidationLayoutAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareJobsPartialUpdateValidationLayoutArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_JobsPartialUpdateValidationLayoutSecurityRequirements,
                operationName: "JobsPartialUpdateValidationLayoutAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/jobs/{id}/validation_layout",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "JobsPartialUpdateValidationLayout",
                                methodName: "JobsPartialUpdateValidationLayoutAsync",
                                pathTemplate: "$\"/api/jobs/{id}/validation_layout\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessJobsPartialUpdateValidationLayoutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessJobsPartialUpdateValidationLayoutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.JobValidationLayoutRead.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.JobValidationLayoutRead>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.JobValidationLayoutRead.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.JobValidationLayoutRead> JobsPartialUpdateValidationLayoutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.PatchedJobValidationLayoutWriteRequest
            {
                FrameSelectionMethod = frameSelectionMethod,
                HoneypotRealFrames = honeypotRealFrames,
            };

            return await JobsPartialUpdateValidationLayoutAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
