...
namespace CVAT
{
    public partial class ProjectsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (xOrganization != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("X-Organization", xOrganization.ToString());
                            ...
                            var __contentProjectFile = new global::System.Net.Http.ByteArrayContent(request.ProjectFile ?? global::System.Array.Empty<byte>());
                            __contentProjectFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.ProjectFilename is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.ProjectFilename) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            __httpRequestContent.Add(
                                content: __contentProjectFile,
                                name: "\"project_file\"",
                                fileName: request.ProjectFilename != null ? $"\"{request.ProjectFilename}\"" : string.Empty);
                            if (__contentProjectFile.Headers.ContentDisposition != null)
                            {
                                __contentProjectFile.Headers.ContentDisposition.FileNameStar = null;
                            }
        ...
        /// The stream to send as the multipart 'project_file' file part.
        /// </param>
        /// <param name="projectFilename"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> ProjectsCreateBackupAsync(
            global::System.IO.Stream projectFile,
            string projectFilename,
            string? xOrganization = default,
            int? cloudStorageId = default,
            string? filename = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            projectFile = projectFile ?? throw new global::System.ArgumentNullException(nameof(projectFile));
            var request = new global::CVAT.ProjectFileRequest
            {
                ProjectFile = global::System.Array.Empty<byte>(),
                ProjectFilename = projectFilename,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            if (xOrganization != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("X-Organization", xOrganization.ToString());
                            ...
                            var __contentProjectFile = new global::System.Net.Http.StreamContent(projectFile);
                            __contentProjectFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.ProjectFilename is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.ProjectFilename) ?? string.Empty).ToLowerInvariant() switch
