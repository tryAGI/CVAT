...
namespace CVAT
{
    public partial class GrowthClient
    {


        private static readonly global::CVAT.EndPointSecurityRequirement s_GrowthPartialUpdateSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_GrowthPartialUpdateSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_GrowthPartialUpdateSecurityRequirement0,
            };
        partial void PrepareGrowthPartialUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::CVAT.PatchedUserGrowthDataRequest request);
        partial void PrepareGrowthPartialUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::CVAT.PatchedUserGrowthDataRequest request);
        partial void ProcessGrowthPartialUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGrowthPartialUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.UserGrowthData> GrowthPartialUpdateAsync(
            string id,
        ...
        {
            var __response = await GrowthPartialUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.UserGrowthData>> GrowthPartialUpdateAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGrowthPartialUpdateArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GrowthPartialUpdateSecurityRequirements,
                operationName: "GrowthPartialUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGrowthPartialUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GrowthPartialUpdate",
                                methodName: "GrowthPartialUpdateAsync",
                                pathTemplate: "$\"/api/growth/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGrowthPartialUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGrowthPartialUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.UserGrowthData.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.UserGrowthData>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.UserGrowthData.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.UserGrowthData> GrowthPartialUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CVAT.PatchedUserGrowthDataRequest
            {
                GithubPromptShown = githubPromptShown,
                GithubPromptSupportClicked = githubPromptSupportClicked,
                PromotionNotificationsAllowed = promotionNotificationsAllowed,
            };

            return await GrowthPartialUpdateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
