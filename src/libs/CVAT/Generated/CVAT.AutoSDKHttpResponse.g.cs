...
namespace CVAT
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::CVAT.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::CVAT.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::CVAT.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::CVAT.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::CVAT.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::CVAT.ApiException exception)
        ...
        private static global::CVAT.AutoSDKRequestOptions CloneRequestOptions(
            global::CVAT.AutoSDKRequestOptions? source)
        {
            var clone = new global::CVAT.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
