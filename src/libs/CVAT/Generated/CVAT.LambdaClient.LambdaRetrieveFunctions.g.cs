...
namespace CVAT
{
    public partial class LambdaClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_LambdaRetrieveFunctionsSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_LambdaRetrieveFunctionsSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_LambdaRetrieveFunctionsSecurityRequirement0,
            };
        partial void PrepareLambdaRetrieveFunctionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string funcId);
        partial void PrepareLambdaRetrieveFunctionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string funcId);
        partial void ProcessLambdaRetrieveFunctionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLambdaRetrieveFunctionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> LambdaRetrieveFunctionsAsync(
            string funcId,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await LambdaRetrieveFunctionsAsResponseAsync(
                funcId: funcId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<string>> LambdaRetrieveFunctionsAsResponseAsync(
            string funcId,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareLambdaRetrieveFunctionsArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_LambdaRetrieveFunctionsSecurityRequirements,
                operationName: "LambdaRetrieveFunctionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareLambdaRetrieveFunctionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "LambdaRetrieveFunctions",
                                methodName: "LambdaRetrieveFunctionsAsync",
                                pathTemplate: "$\"/api/lambda/functions/{funcId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessLambdaRetrieveFunctionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLambdaRetrieveFunctionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
