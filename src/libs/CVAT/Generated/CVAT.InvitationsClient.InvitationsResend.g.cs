...
namespace CVAT
{
    public partial class InvitationsClient
    {
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement s_InvitationsResendSecurityRequirement0 =
        ...
        private static readonly global::CVAT.EndPointSecurityRequirement[] s_InvitationsResendSecurityRequirements =
            new global::CVAT.EndPointSecurityRequirement[]
            {                s_InvitationsResendSecurityRequirement0,
            };
        partial void PrepareInvitationsResendArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string key);
        partial void PrepareInvitationsResendRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string key);
        partial void ProcessInvitationsResendResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task InvitationsResendAsync(
            string key,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await InvitationsResendAsResponseAsync(
                key: key,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse> InvitationsResendAsResponseAsync(
            string key,
            global::CVAT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInvitationsResendArguments(
            ...
            var __authorizations = global::CVAT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InvitationsResendSecurityRequirements,
                operationName: "InvitationsResendAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CVAT.PathBuilder(
                                path: $"/api/invitations/{key}/resend",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInvitationsResendRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "InvitationsResendAsync",
                                pathTemplate: "$\"/api/invitations/{key}/resend\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInvitationsResendResponse(
                    httpClient: HttpClient,
