...
namespace CVAT
{
    public partial class ProjectsClient
    {
        ...
        {
            var __response = await ProjectsCreateDatasetAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> ProjectsCreateDatasetAsResponseAsync(
            int id,
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __contentDatasetFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.DatasetFilename is null
                                    ...
                                    : (global::System.IO.Path.GetExtension(request.DatasetFilename) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            __httpRequestContent.Add(
                                content: __contentDatasetFile,
                                name: "\"dataset_file\"",
                                fileName: request.DatasetFilename != null ? $"\"{request.DatasetFilename}\"" : string.Empty);
                            if (__contentDatasetFile.Headers.ContentDisposition != null)
                            {
                                __contentDatasetFile.Headers.ContentDisposition.FileNameStar = null;
                            }
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsCreateDataset",
                                methodName: "ProjectsCreateDatasetAsync",
                                pathTemplate: "$\"/api/projects/{id}/dataset/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
        ...
        /// <param name="id"></param>
        /// <param name="location"></param>
        /// <param name="datasetFile">
        /// The stream to send as the multipart 'dataset_file' file part.
        /// </param>
        /// <param name="datasetFilename"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        ...
        public async global::System.Threading.Tasks.Task<global::CVAT.RqId> ProjectsCreateDatasetAsync(
            int id,
            global::System.IO.Stream datasetFile,
            string datasetFilename,
            int? cloudStorageId = default,
            string? filename = default,
            string? format = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            datasetFile = datasetFile ?? throw new global::System.ArgumentNullException(nameof(datasetFile));
            var request = new global::CVAT.DatasetFileRequest
            {
                DatasetFile = global::System.Array.Empty<byte>(),
                DatasetFilename = datasetFilename,
            };
            PrepareArguments(
                client: HttpClient);
