...
namespace CVAT
{
    public partial class JobsClient
    {
        ...
        {
            var __response = await JobsCreateDatasetExportAsResponseAsync(
                format: format,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.RqId>> JobsCreateDatasetExportAsResponseAsync(
            string format,
            int id,
            int? cloudStorageId = default,
            string? filename = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "JobsCreateDatasetExport",
                                methodName: "JobsCreateDatasetExportAsync",
                                pathTemplate: "$\"/api/jobs/{id}/dataset/export\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
