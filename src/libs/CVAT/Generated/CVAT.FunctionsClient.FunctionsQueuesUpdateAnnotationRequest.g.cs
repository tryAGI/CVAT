...
namespace CVAT
{
    public partial class FunctionsClient
    {
        ...
        {
            await FunctionsQueuesUpdateAnnotationRequestAsResponseAsync(
                id: id,
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse> FunctionsQueuesUpdateAnnotationRequestAsResponseAsync(
            string id,
            string requestId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FunctionsQueuesUpdateAnnotationRequest",
                                methodName: "FunctionsQueuesUpdateAnnotationRequestAsync",
                                pathTemplate: "$\"/api/functions/queues/{id}/requests/{requestId}/update\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
