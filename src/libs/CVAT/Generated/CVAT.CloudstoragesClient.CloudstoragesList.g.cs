...
namespace CVAT
{
    public partial class CloudstoragesClient
    {
        ...
        {
            var __response = await CloudstoragesListAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CVAT.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedCloudStorageReadList>> CloudstoragesListAsResponseAsync(
            string? xOrganization = default,
            global::CVAT.CloudstoragesListCredentialsType? credentialsType = default,
            string? filter = default,
            string? name = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CVAT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CloudstoragesList",
                                methodName: "CloudstoragesListAsync",
                    ...
                    await global::CVAT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CVAT.PaginatedCloudStorageReadList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CVAT.AutoSDKHttpResponse<global::CVAT.PaginatedCloudStorageReadList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CVAT.PaginatedCloudStorageReadList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
